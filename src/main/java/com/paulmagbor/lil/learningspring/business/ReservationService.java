package com.paulmagbor.lil.learningspring.business;
...
public class ReservationService {
    // need to make these final since we don't want them to change (they're all singletons in the IoC container)
    private final RoomRepository roomRepository;
    private final GuestRepository guestRepository;
    private final ReservationRepository reservationRepository;

    // use contructor to inject dependencies
    // need to use '@Autowired' here if you define more that one constructor
